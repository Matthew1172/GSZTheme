        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <form id="signup" method="POST">
                    ...
                    <ul class="form-list">
                        <li><input id="signupCaptcha" type="hidden"></li>
                        ...
                        <div class="partB" id="instructorPartB" style="display:none;">
                            <li><input id="instructor-company" type="text" name="instructor_company" placeholder="Company name" class="form-control" aria-label="small" data-toggle="tooltip" title="Enter the name of your company"></li>
                        </div>
